  ...
  return (
    <div id="contact" className="py-8">
      ...
      <div className="md:flex gap-14">
        ...
        <form
          data-aos="fade-left"
          action="https://formspree.io/f/xgvebklg"
          method="POST"
          className="md:w-8/12 overflow-hidden rounded bg-black text-slate-500 mb-8"
        >
          {/*  <!-- Body--> */}
          ...
          <div className="flex justify-end px-6">
            <button
              type="submit"
              className="btn bg-white text-black mt-5 font-semibold p-3 px-5 rounded hover:bg-yellow-600 hover:text-white transition duration-300 w-full"
            >
